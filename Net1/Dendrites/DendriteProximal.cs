...
namespace Net1
{
	public class DendriteProximal : Dendrite
	{
		//List of Synapses on this Dendrite.
		public List<SynapseProximal> Synapses { get; private set; }


		#region Constructors

		public DendriteProximal(int threshold) :base(threshold)
		{
			Synapses = new List<SynapseProximal>();
		}
		...
		{
			ActivationSum = 0;
			foreach (SynapseProximal syn in Synapses)
			{
				ActivationSum += syn.Update();
			}
