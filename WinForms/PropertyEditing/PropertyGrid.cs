...
namespace AdamsLair.WinForms.PropertyEditing
{
	...
	public partial class PropertyGrid : UserControl
	{
		...
		private int updateTimerScheduleMs = 0;
		...
		public void SelectObject ( object obj, bool readOnly = false, int scheduleMs = 0 )
		{
			...
			//enable auto update - added
			SetUpdateSchedule ( scheduleMs );
		}

		public void SetUpdateSchedule ( int scheduleMs = 0 )	//added
		{
			if (scheduleMs > 0)
			{
				this.updateTimerScheduleMs = scheduleMs;
		...
		public void UpdateFromObjects ()
		{
			//if (scheduleMs > 0)
			//{
			//	this.updateTimerScheduleMs = scheduleMs;	//added
			//	this.updateTimerChangeMs = scheduleMs;
			//	this.updateScheduled = true;
			//	return;
			//}
		...
		private void updateTimer_Tick ( object sender, EventArgs e )
		{
			if (this.updateScheduled)
			{
				...
				if (this.updateTimerChangeMs <= 0)
				{
					this.updateTimerChangeMs = this.updateTimerScheduleMs;

					this.UpdateFromObjects ();
				}
			}
			if (TimerEventHandler != null)
				TimerEventHandler ( this, EventArgs.Empty );
		}

		public event TimerDoneEventHandler TimerEventHandler;
